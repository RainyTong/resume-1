...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Homepage: \href{https://rainytong.github.io/}{https://rainytong.github.io/} & Mobile : +86 15610502699 \\
\end{tabular*}
%-----------EDUCATION-----------------
\section{Education}
...
%        \end{itemize}
    ...
    \resumeSubheading
      ...
      {Summer Program}{Jul. 2019 -- Sept. 2019}
      {}{}
%        \begin{itemize}
%         \item GPA: 4.0/4.0
%        \end{itemize}
...
\section{Skills}
 \resumeSubHeadingListStart
   ...
   \item{
      \textbf{Programming Languages}{: Java, Python, C/C++, SQL, Javascripts, HTML, LaTex}
   }
   \item{
      \textbf{Tools}{: Git, PyTorch}
   }
...
\section{Publications}
 \resumeSubHeadingListStart
   ...
   \item{\textbf{Yutong Wang}, Yufei Han, Hongyan Bao, Yun Shen, Fenglong Ma, Jin Li and Xiangliang Zhang. \textbf{Attackability Characterization of Adversarial Evasion Attack on Discrete Data}. Accepted by the 26th SIGKDD Conference on Knowledge Discovery and Data Mining (\href{https://www.kdd.org/kdd2020/}{KDD 2020}), August 22 - 27, 2020 - San Diego, CA - USA. (Acceptance rate 216/1279=16.9\%).}
...
%     \resumeSubheading
%     {PLSE Group, University of California Davis}{Davis, CA}
%       {Led a project focusing on software engineering}{Oct. 2020 - Present}
%       {Supervisor: Cindy Rubio Gonzalez}{}
%       {Funding Source: Graduate Fellowship from UC Davis, and National Science Foundation}
      
%     \resumeSubheading
%     {MINE Group, King Abdullah University of Science and Technology (KAUST)}{Thuwal, Saudi Arabia}
%       {Led a project focusing on the adversarial machine learning}{Sept. 2019 - Jan. 2020}
%       {Supervisor: Xiangliang Zhang}{}
%       {Funding Source: KAUST}{}
     
%      \resumeSubheading
%     {ISG Group, University of California Irvine}{Irvine, CA}
%       {Worked on the California Wildfire project}{Jul. 2019 - Sept. 2019}
%       {Supervisor: Chen Li}{}
...
%     \item {Outstanding Students Scholarship at SUSTech, 2017 - 2019 }
...
%           \item Leveraged heuristic clustering algorithms to analyze the quality of embedding learned for discrete knowledge
    ...
    \resumeSubheading
      ...
      {\textit{Wildfire Detection using Social Media}, [\href{https://github.com/ISG-ICS/Wildfires}{Github}] }{}
    ...
    \resumeSubheading
      ...
      {\textit{News Discovery from Database and Headlines Generation}}{}
        ...
        \begin{itemize}
          ...
          \item Leveraged Skip-Gram, CBOW to train the word embedding for news headlines corpus
