...
%           \item Achieved a higher performance on the state-of-the-art LSTM medical predictive model via designing a novel embedding with attention mechanism
            \item Achieved a state-of-the-art prediction performance on the LSTM binary feature predictive model
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
      \textbf{Selected Core Courses}{: Software Engineering, Operating Systems, Computer Organization, Computer Networks, Artificial Intelligence, Deep Learning}
   }
   \item{
...
% class management
       \item Designed an Deep Learning Android app for SUSTecher with the innovation point of positioning campus buildings by images and navigating user 
       \item Techniques: Volley Web Framework, Gaode(AMap) Maps Framework, Spring Boot, PyTorch
       \end{itemize}
...
% Bash, JavaScript
       ...
       \item Techniques: React.js, Spring Boot, Docker
       \end{itemize}
