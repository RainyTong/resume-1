...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {}{}
      \begin{itemize}
      \item GPA (total): 89/100
      \\ 
      GPA (sophomore \& junior): 92/100
...
%           \item Achieved a higher performance on the state-of-the-art LSTM medical predictive model via designing a novel embedding with attention mechanism
            \item Achieved state-of-the-art prediction performance on medical dataset using binary feature classification model based on Long Short-Term Memory (LSTM)
          
%           \item Leveraged heuristic clustering algorithms to analyze the quality of embedding learned for discrete knowledge

          \item Conducted a comprehensive literature survey on the baseline approaches to adversarial attacks generation and adversarial machine learning
    ...
    \resumeSubheading
      ...
      {\textit{Wildfire Detection using Social Media}, [\href{https://github.com/ISG-ICS/Wildfires}{Github}], [\href{http://wildfires.ics.uci.edu:2333/}{Website}]}{}
        ...
        \begin{itemize}
          ...
          \item Implemented Text CNN tweets classifier, VGG Net for image classification and conducted comprehensive experiments on self-built Twitter dataset, achieved wildfire detection through social media
    ...
    \resumeSubheading
      ...
      {\textit{News Discovery from Database and Headlines Generation}}{}
        ...
        \begin{itemize}
          ...
          \item Explored top-k newsworthy fact from multidimensional dataset by implementing and comparing algorithms such as skyline algorithm and longest streak discovery algorithm
          ...
          \item Implemented a novel table-to-sequence model with Gated Recurrent Units (GRU) for news headline generation leveraging attention mechanism and copy mechanism
        \end{itemize}
  \resumeSubHeadingListEnd
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
      \textbf{Selected Core Courses}{: Software Engineering, Operating Systems, Computer Networks, Artificial Intelligence, Deep Learning}
   }
   \item{
      \textbf{Development}{: Proficient in Java, Python, C/C++, SQL; Experience with Javascripts, HTML, Assembly}
   }
   \item{
...
\section{Notable Course Projects}
  ...
  \resumeSubItem
       ...
       \item Improved a half-developed system kernel by implementing Argument Passing, Process Control Syscalls, and File Operation Syscalls
...
% class management
       \item Designed a Android App supporting functions like map localization, navigation, building recognition, class management by utilizing Deep Learning models 
