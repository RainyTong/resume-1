...
%         \end{itemize}
    ...
    \resumeSubheading
      ...
      {Research Assistant, Advisor: \href{https://chenli.ics.uci.edu/}{Professor Bo Tang}}{June. 2018 - June. 2019}
      {\textit{News Headlines Generation with a Data-driven Approach}}{}
        ...
        \begin{itemize}
          ...
          \item Crawled large-scalenewsheadlinesandcorrespondingdatainformationfrompublicwebsites(e.g.www.espn.com).
