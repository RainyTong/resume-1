    ...
    \resumeSubheading
      ...
      {\textit{News Headlines Generation with a Data-driven Approach}}{}
        ...
        \begin{itemize}
          ...
          \item Explored newsworthy fact from multidimensional dataset through algorithms such as skyline algorithm and longest streak discovery algorithm
          \item Compared effectiveness of different techniques to train the word embedding such as skip-gram, CBOW and GloVe
