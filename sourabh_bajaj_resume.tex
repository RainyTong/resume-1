...
%           \item Achieved a higher performance on the state-of-the-art LSTM medical predictive model via designing a novel embedding with attention mechanism
            \item Achieved a state-of-the-art prediction performance on the LSTM medical predictive model
          
          \item Leveraged heuristic clustering algorithms to analyze the quality of embedding learned for medical knowledge from Electronic Health Records (EHR)
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
      \textbf{Core Courses}{: Artificial Intelligence, Deep Learning, Data Mining, Linear Algebra, Probability and Statistics}
   }
   \item{
