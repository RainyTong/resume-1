...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.E. Computer Science and Engineering}{Sept. 2016 -- Jun. 2020 (Expected)}
      {}{}
      \begin{itemize}
    ...
    \resumeSubheading
      ...
      {\textit{News Discovery from Database and Headlines Generation}}{}
        ...
        \begin{itemize}
          ...
          \item Implemented a table-to-sequence model with Gated Recurrent Units (GRU) for news headline generation leveraging attention mechanism and copy mechanism
        \end{itemize}
  \resumeSubHeadingListEnd
