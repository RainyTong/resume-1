...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\textit{Discrete Adversarial Attacks on Binary Code Classification}}{}
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
      \textbf{Selected Core Courses}{: Software Engineering, Operating Systems, Object-oriented Analysis and Design, Computer Organization, Artificial Intelligence, Deep Learning}
   }
   \item{
...
\section{Notable Course Projects}
  ...
  \resumeSubItem
       {PintOS Threads \& User Programs \& File System}{Operating Systems}
       \begin{itemize}
  ...
  \resumeSubItem
      {Hello SUSTech [\href{https://github.com/RainyTong/Hello-SUSTech}{Github}]}{Software Engineering}
       \begin{itemize}
   ...
   \resumeSubItem
      {SUSTech Lambda [\href{https://github.com/Henrycobaltech/SUSTechLambda}{Github}]}{Object-oriented Analysis and Design}
       \begin{itemize}
