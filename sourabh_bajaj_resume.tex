...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Research Intern, King Abdullah University of Science and Technology}{Sept. 2019 - Jan. 2020}
      ...
      {supervised by Prof. Xiangliang Zhang}{}
     
     \resumeSubheading
    {Research Assistant, University of California Irvine}{Jul. 2019 - Sept. 2019}
      {Worked on the California Wildfire project}{}
      {supervised by Prof. Chen Li}{}
      
     \resumeSubheading
    {Research Assistant, SUSTech}{Jul. 2018 - Jun. 2019}
      {Led a research project focusing on news headlines generation in Natural Language Processing}{}
      {supervised by Prof. Bo Tang}{}
...
\section{Notable Course Projects}
  ...
  \resumeSubItem
       ...
       \item Improved a half-developed system kernel by implementing Parameters Passing, Process Control system calls, and File Management system calls
