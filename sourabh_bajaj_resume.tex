  ...
  \resumeSubItem
   ...
   \resumeSubItem
      {SUSTech Lambda [\href{https://github.com/Henrycobaltech/SUSTechLambda}{Github}]}{}
       \begin{itemize}
       \item Developed an easily customized web platform to execute and share scripts online which supports authority and group management, including techniques such as React, MongoDB, JAVA Spring Boot and Kotlin
       \item 
       \end{itemize}
