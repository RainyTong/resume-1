    ...
    \resumeSubheading
      ...
      {\textit{Discrete Adversarial Attacks on Medical Predictive Models}}{}
        ...
        \begin{itemize}
          ...
          \item Exploring an innovative framework using the gradient of the attacked classifier to guide the greedy search for generating discrete attacks [\textit{in progress}]
