    ...
    \resumeSubheading
      ...
      {\textit{Discrete Adversarial Attacks on Medical Predictive Models}}{}
        ...
        \begin{itemize}
          ...
          \item Conducted a framework using the gradient of the attacked classifier to guide the greedy search, and to generate discrete white-box adversarial attacks on the medical predictive classifier 
        \end{itemize}
